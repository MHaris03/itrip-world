...
const AddNewTour = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await addDoc(collection(db, "newTour"), data);
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          <Row>
            <Col md={6}>
              ...
              <FloatingLabel label="Couple Price" className={`${classes.label} mb-3`}>
                <Form.Control
                  type="number"
                  min="0"
                  placeholder="Couple Price"
                  className={classes.input}
                  {...register("coupleprice", { required: true })}
                />
                {errors.price && (
                  <small className="error">*Couple Price is required!</small>
                )}
              </FloatingLabel>
            ...
            <Col md={6}>
              ...
              >
                <Form.Control
                  ...
                  className={classes.input}
                  type="date"
                  {...register("endDates", { required: true })}
                />
                {errors.startDates && (
                  <small className="error">*Tour End Date is required!</small>
                )}
              </FloatingLabel>
            </Col>
          </Row>
